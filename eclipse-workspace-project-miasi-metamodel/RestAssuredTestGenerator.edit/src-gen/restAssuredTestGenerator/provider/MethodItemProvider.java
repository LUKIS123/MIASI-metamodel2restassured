...
/**
 * This is the item provider adapter for a {@link restAssuredTestGenerator.Method} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MethodItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addOptionalPathPropertyDescriptor(object);
		}
	...
	protected void addHttpMethodPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Method_httpMethod_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Method_httpMethod_feature",
								"_UI_Method_type"),
						RestAssuredTestGeneratorPackage.Literals.METHOD__HTTP_METHOD, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Optional Path feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addOptionalPathPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Method_optionalPath_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Method_optionalPath_feature",
								"_UI_Method_type"),
						RestAssuredTestGeneratorPackage.Literals.METHOD__OPTIONAL_PATH, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		HttpMethod labelValue = ((Method) object).getHttpMethod();
